...
public class NeedleTest {
    ...
    public void tests() {
        ...
        assertEquals("found the needle at position 3", Needle.findNeedle(haystack1));
        assertEquals("found the needle at position 5", Needle.findNeedle(haystack2));
        assertEquals("found the needle at position 30", Needle.findNeedle(haystack3));
    }
}
